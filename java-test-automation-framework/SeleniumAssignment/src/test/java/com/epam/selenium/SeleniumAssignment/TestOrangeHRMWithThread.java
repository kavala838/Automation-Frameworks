...
public class TestOrangeHRMWithThread {
	WebDriver driver;
	...
	public void testNavigateToUsers() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"menu_admin_viewAdminModule\"]/a/span[3]")).click();

		driver.findElement(By.xpath("//*[@id=\"menu_admin_UserManagement\"]/a/span[3]")).click();
		Thread.sleep(1000);
	...
	public void testTheChangesAdded() throws InterruptedException {
		...
		WebElement spanElement = driver.findElement(
				By.xpath("//*[@id=\"systemUserDiv\"]/crud-panel/div/div/list/table/tbody/tr[6]/td[3]/ng-include/span"));
