package com.epam.TestAutomation.Project.API.Tests;
...
public class TestAPIOfAttendanceSheet {
	...
	@Test(priority=8)
	public void TestTotalAttendanceSheets() {
		ArrayList<String> SheetIds=HttpsMethods.GetAttendanceSheets();
		assertTrue(SheetIds.size()==36);
	}
	...
	public void TestTotalHoursAggregation(ITestContext context) {
		...
		String duration=HttpsMethods.getTotalHoursOfAttendanceSheet(context,(String)context.getAttribute("latestSheetId"));
		...
		String durationAfterNewSession=HttpsMethods.getTotalHoursOfAttendanceSheet(context,(String)context.getAttribute("latestSheetId"));
	...
	@AfterClass
	public void deleteAllSessionsCreated() {
		try {
